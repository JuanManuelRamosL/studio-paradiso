      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-6">
          <div className="flex gap-4">
            ...
            >
              <Youtube className="w-7 h-7 hover:scale-110 transition-transform" />
            </Link>
            <Link
              href="https://www.instagram.com/studioparadiso.ok/"
              className="text-[#C5B358] transition duration-300 hover:text-[#B4A347]"
            >
              <Instagram className="w-7 h-7 hover:scale-110 transition-transform" />
            </Link>
            ...
            <Link
              ...
              className="text-[#C5B358] transition duration-300 hover:text-[#B4A347]"
            >
              <MessageCircle className="w-7 h-7 hover:scale-110 transition-transform" />
            </Link>
          </div>
